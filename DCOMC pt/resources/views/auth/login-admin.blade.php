...
@section('portal_name', 'Admin Portal Login')
...
@section('content')
    ...
    <form method="POST" action="/login" class="js-auth-form" aria-label="Admin portal login" data-loading-text="Signing in…">
        @csrf
        ...
        <div class="login-remember-forgot">
            ...
            @if (Route::has('password.request'))
                <a href="{{ route('password.request') }}?portal=admin" aria-label="Forgot your password?">Forgot your password?</a>
            @endif
        </div>
...
@section('badge', 'Administrator Access Only')
    ...
    <script>
        if (!/Mobi|Android|iPhone|iPad|iPod/i.test(navigator.userAgent)) {
            ...
            document.addEventListener('keydown', function (e) {
                ...
                if (e.key === 'ArrowRight') { e.preventDefault(); showSwitchPopup('/'); }
                else if (e.key === 'ArrowLeft') { e.preventDefault(); showSwitchPopup('/dcomc-login'); }
            });
