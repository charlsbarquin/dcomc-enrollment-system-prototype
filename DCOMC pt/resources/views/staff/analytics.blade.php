...
<body class="bg-gray-50 min-h-screen text-gray-800 font-data flex">
    ...
    <main id="main-content" class="flex-1 flex flex-col min-w-0" role="main" tabindex="-1">
        @php
        ...
        <div id="analytics-content-scroll" class="{{ (request()->routeIs('registrar.*') || request()->routeIs('admin.*') || request()->routeIs('unifast.*') || request()->routeIs('dean.*')) ? 'w-full flex flex-col pt-2 px-8 pb-8 space-y-6' : 'p-6 flex flex-col gap-6' }}">
