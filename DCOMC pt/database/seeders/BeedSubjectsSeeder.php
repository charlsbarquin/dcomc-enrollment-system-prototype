...
/**
 * Seeds subjects for Bachelor of Elementary Education (BEED) from the 4-year curriculum.
 * Program → Year → First/Second Semester structure.
 */
class BeedSubjectsSeeder extends Seeder
{
    protected string $programName = 'Bachelor of Elementary Education';
    ...
    public function run(): void
    {
        ...
        $this->command->info('BEED subjects seeded by year and semester.');
    }
    ...
    private function getCurriculum(): array
    {
        return [
            ...
            ['code' => 'GE 6', 'title' => 'Art Appreciation', 'units' => 3, 'year' => '1st Year', 'semester' => 'First Semester'],
            ...
            ['code' => 'GE ELEC 2', 'title' => 'Philippine Popular Culture', 'units' => 3, 'year' => '1st Year', 'semester' => 'Second Semester'],
            ['code' => 'GE ELEC 3', 'title' => 'Living in the IT Era', 'units' => 3, 'year' => '1st Year', 'semester' => 'Second Semester'],
            ...
            ['code' => 'MC FIL 1', 'title' => 'Pagtuturo ng Filipino sa Elementarya (I) Estruktura at Gamit ng Wikang Filipino', 'units' => 3, 'year' => '2nd Year', 'semester' => 'First Semester'],
            ['code' => 'MC SCI 1', 'title' => 'Teaching Science in the Primary Grades (Biology and Chemistry)', 'units' => 3, 'year' => '2nd Year', 'semester' => 'First Semester'],
            ['code' => 'MC MATH 1', 'title' => 'Teaching Mathematics in the Primary Grades', 'units' => 3, 'year' => '2nd Year', 'semester' => 'First Semester'],
            ['code' => 'MC SSC 1', 'title' => 'Teaching Social Studies in the Primary Grades (Culture and Basic Geography)', 'units' => 3, 'year' => '2nd Year', 'semester' => 'First Semester'],
            ['code' => 'MC MTB-MLE', 'title' => 'Content and Pedagogy for the Mother Tongue', 'units' => 3, 'year' => '2nd Year', 'semester' => 'First Semester'],
            ['code' => 'MC PEH', 'title' => 'Teaching PE and Health in the Elementary Grades', 'units' => 3, 'year' => '2nd Year', 'semester' => 'First Semester'],
            ['code' => 'MC VED', 'title' => 'Good Manners and Right Conduct (Edukasyon sa Pagpapakatao)', 'units' => 3, 'year' => '2nd Year', 'semester' => 'First Semester'],
            ...
            ['code' => 'MC FIL 2', 'title' => 'Pagtuturo ng Filipino sa Elementarya (II) Panitikan ng Pilipinas', 'units' => 3, 'year' => '2nd Year', 'semester' => 'Second Semester', 'prerequisites' => 'MC FIL 1'],
            ['code' => 'MC SCI 2', 'title' => 'Teaching Science in the Intermediate Grades (Physics, Earth, and Space Science)', 'units' => 3, 'year' => '2nd Year', 'semester' => 'Second Semester', 'prerequisites' => 'MC SCI 1'],
            ['code' => 'MC MATH 2', 'title' => 'Teaching Mathematics in the Intermediate Grades', 'units' => 3, 'year' => '2nd Year', 'semester' => 'Second Semester', 'prerequisites' => 'MC MATH 1'],
            ['code' => 'MC SSC 2', 'title' => 'Teaching Social Studies in the Intermediate Grades (Philippine History and Government)', 'units' => 3, 'year' => '2nd Year', 'semester' => 'Second Semester', 'prerequisites' => 'MC SSC 1'],
            ['code' => 'MC ARTS', 'title' => 'Teaching Arts in the Elementary Grades', 'units' => 3, 'year' => '2nd Year', 'semester' => 'Second Semester'],
            ['code' => 'MC MUSIC', 'title' => 'Teaching Music in the Elementary Grades', 'units' => 3, 'year' => '2nd Year', 'semester' => 'Second Semester'],
            ...
            ['code' => 'MC ENG 1', 'title' => 'Teaching English in the Elementary Grades (Language Arts)', 'units' => 3, 'year' => '3rd Year', 'semester' => 'First Semester'],
            ['code' => 'MC TLE 1', 'title' => 'Edukasyong Pantahanan at Pangkabuhayan', 'units' => 3, 'year' => '3rd Year', 'semester' => 'First Semester'],
            ['code' => 'ELECTIVE', 'title' => 'Teaching Multi-Grade Classes', 'units' => 3, 'year' => '3rd Year', 'semester' => 'First Semester'],
            ['code' => 'MC RES 1', 'title' => 'Research in Teaching', 'units' => 3, 'year' => '3rd Year', 'semester' => 'First Semester'],
            ...
            ['code' => 'MC ENG 2', 'title' => 'Teaching Literacy in the Elementary Grades Through Literature', 'units' => 3, 'year' => '3rd Year', 'semester' => 'Second Semester', 'prerequisites' => 'MC ENG 1'],
            ['code' => 'MC TLE 2', 'title' => 'Edukasyong Pantahanan at Pangkabuhayan with Entrepreneurship', 'units' => 3, 'year' => '3rd Year', 'semester' => 'Second Semester', 'prerequisites' => 'MC TLE 1'],
            ['code' => 'MC TTL 2', 'title' => 'Application of Technology for Teaching and Learning 2 in the Elementary Grades', 'units' => 3, 'year' => '3rd Year', 'semester' => 'Second Semester'],
            ['code' => 'MC RES 2', 'title' => 'Research in Teaching', 'units' => 3, 'year' => '3rd Year', 'semester' => 'Second Semester', 'prerequisites' => 'MC RES 1'],
